# 📄 Desafio 014 - Módulo 03 - Capítulo 21

## 📌 Enunciado

Desafio proposto no capítulo **"Tabelas"** do curso de HTML e CSS da plataforma **Curso em Vídeo**.

👉 [Material original](https://github.com/gustavoguanabara/html-css/blob/master/aulas-pdf/21%20-%20Tabelas.pdf)
...
* Como montar tabelas complexas com múltiplos níveis de cabeçalho  
* Diferença entre células de dados (`td`) e cabeçalhos (`th`)  
* Uso de `rowspan` para unir linhas relacionadas  
